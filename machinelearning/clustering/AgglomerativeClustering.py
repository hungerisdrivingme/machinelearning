...
# AgglomerativeClustering(Hierarchical Clust)
...
dendrogham=sch.dendrogram(sch.linkage(X,method="ward"))   #dendogram cizildi. Maks uzaklık k=2 alınabilir. Maviden bölünmesi mantıklı
                                                            # k 4 de alınabilir makul
plt.show()
