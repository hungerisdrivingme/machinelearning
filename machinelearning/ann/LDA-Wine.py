# -*- coding: utf-8 -*-
"""
Created on Sat Mar 19 12:30:22 2022
...
X_train_lda= lda.fit_transform(X_train,y_train)  #LDA'de sadece xtraini degil y traini de veriyoruz cünkü supervised ile calisiyor
...
#LDA sonrası/orjınal
print("lda ve orjınal")            #LDA daha basarılı sonuc verdi cünkü supervised ögrenme
